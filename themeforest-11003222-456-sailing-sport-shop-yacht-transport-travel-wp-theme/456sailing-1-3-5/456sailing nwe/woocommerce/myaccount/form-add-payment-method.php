	...
	<form id="add_payment_method" method="post">
		<div id="payment" class="woocommerce-Payment">
			...
			<div class="form-row">
				...
				<input type="submit" class="woocommerce-Button woocommerce-Button--alt <?php echo product_post_button_class();?>" id="place_order" value="<?php esc_attr_e( 'Add payment method', 'woocommerce' ); ?>" />
