...
<?php if(!$header_meta):?>
<div class="header-top"<?php if ($header_meta_background=='custom'||$hm_custom_bg) { ?> style="<?php if ($header_meta_background=='custom') { ?>background-image:url(<?php echo esc_attr($hm_custom_pattern);?>);<?php } ?><?php if ($hm_custom_bg) { ?>background-color: <?php echo esc_attr($hm_custom_bg);?>;<?php } ?>"<?php } ?>>
