...
<?php $s_cart_style = ot_get_option('s_cart_style');?>

<?php if (is_plugin_active('woocommerce/woocommerce.php')) {?>

<?php if($s_cart!=''){ ?>
<?php if(!$catalog_type){?>
	<div class="lpd-shopping-cart lpd-shopping-cart-fix<?php if ($s_cart=='sl_panel_right'||$s_cart=='sl_panel_left') { ?> lpd-shopping-cart-scotchpanel<?php } ?><?php if ($s_cart_style) { echo ' lpd-shopping-cart-'.esc_attr($s_cart_style); } ?>">
