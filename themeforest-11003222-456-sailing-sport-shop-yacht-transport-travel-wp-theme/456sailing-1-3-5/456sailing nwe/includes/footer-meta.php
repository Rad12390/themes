...
$fm_column1_sub = ot_get_option('fm_column1_sub');
$fm_column1_img = ot_get_option('fm_column1_img');
$fm_column2_sub = ot_get_option('fm_column2_sub');
$fm_column2_img = ot_get_option('fm_column2_img');
$fm_column3_sub = ot_get_option('fm_column3_sub');
$fm_column3_img = ot_get_option('fm_column3_img');
$fm_column4_sub = ot_get_option('fm_column4_sub');
$fm_column4_img = ot_get_option('fm_column4_img');
$sm_sub = ot_get_option('sm_sub');

$fm_column1_padding = ot_get_option('fm_column1_padding');
$fm_column2_padding = ot_get_option('fm_column2_padding');
$fm_column3_padding = ot_get_option('fm_column3_padding');
$fm_column4_padding = ot_get_option('fm_column4_padding');
$sm_padding = ot_get_option('sm_padding');
...
?>
	...
	<div id="footer-meta">
		...
		<div class="container footer-meta-container<?php if(!$fm_column1_img){?><?php if($fm_column1_sub){?> fm-min-height<?php }?><?php }?><?php if($fm_column1_img||$social_media){?>  fm-min-height-img<?php }?><?php if(!$sm_sub&&$social_media){?>  fm-min-height-no-sm-sub<?php }?>">
			<div class="row">
				<?php if($column_1){?>
				<div class="the-first-fm-column <?php echo esc_attr($column_type);?>">
					<?php if($social_media){?>
					<div class="social-media clearfix lpd-animated-link<?php if($footer_meta_a_type){?> cre-animate<?php }?>" style="padding-top: <?php echo esc_attr($sm_padding);?>px;"<?php if($footer_meta_a_type){ echo $animation_att;}?>>
					
						<?php if($sm_label){?><div class="sm_label"><?php echo esc_html($sm_label);?></div><?php }?>
						<?php get_template_part('includes/footer_social_media' ) ?>
						<?php if($sm_sub){?><div class="sm-subtitle"><?php echo esc_html($sm_sub);?></div><?php }?>
						
					</div>
					<?php }else{?>
						<div class="item<?php if($footer_meta_a_type){?> cre-animate<?php }?>" style="padding-top: <?php echo esc_attr($fm_column1_padding);?>px;"<?php if($footer_meta_a_type){ echo $animation_att;}?>>
							<div class="fm-item-title"><?php echo esc_html($column1);?></div>
							<?php if($fm_column1_img){?><div class="fm-item-img"><img alt="<?php echo esc_attr($column1);?>" src="<?php echo esc_url($fm_column1_img);?>"/></div><?php }?>
							<?php if(!$fm_column1_img){?><?php if($fm_column1_sub){?><div class="fm-item-separator"></div><?php }?><?php }?>
							<?php if($fm_column1_sub){?><div class="fm-item-subtitle"><?php echo esc_html($fm_column1_sub);?></div><?php }?>
						</div>
					<?php }?>
				</div>
				<?php }?>
				<?php if($column2){?>
					<div class="<?php echo esc_attr($column_type);?>"><div class="item<?php if($footer_meta_a_type){?> cre-animate<?php }?>" style="padding-top: <?php echo esc_attr($fm_column2_padding);?>px;"<?php if($footer_meta_a_type){ echo $animation_att;}?>>
						<div class="fm-item-title"><?php echo esc_html($column2);?></div>
						<?php if($fm_column2_img){?><div class="fm-item-img"><img alt="<?php echo esc_attr($column2);?>" src="<?php echo esc_url($fm_column2_img);?>"/></div><?php }?>
						<?php if(!$fm_column2_img){?><?php if($fm_column2_sub){?><div class="fm-item-separator"></div><?php }?><?php }?>
						<?php if($fm_column2_sub){?><div class="fm-item-subtitle"><?php echo esc_html($fm_column2_sub);?></div><?php }?>
					</div></div>
				<?php }?>
				<?php if($column3){?>
					<div class="<?php echo esc_attr($column_type);?>"><div class="item<?php if($footer_meta_a_type){?> cre-animate<?php }?>" style="padding-top: <?php echo esc_attr($fm_column3_padding);?>px;"<?php if($footer_meta_a_type){ echo $animation_att;}?>>
						<div class="fm-item-title"><?php echo esc_html($column3);?></div>
						<?php if($fm_column3_img){?><div class="fm-item-img"><img alt="<?php echo esc_attr($column3);?>" src="<?php echo esc_url($fm_column3_img);?>"/></div><?php }?>
						<?php if(!$fm_column3_img){?><?php if($fm_column3_sub){?><div class="fm-item-separator"></div><?php }?><?php }?>
						<?php if($fm_column3_sub){?><div class="fm-item-subtitle"><?php echo esc_html($fm_column3_sub);?></div><?php }?>
					</div></div>
				<?php }?>
				<?php if($column4){?>
					<div class="<?php echo esc_attr($column_type);?>"><div class="item<?php if($footer_meta_a_type){?> cre-animate<?php }?>" style="padding-top: <?php echo esc_attr($fm_column4_padding);?>px;"<?php if($footer_meta_a_type){ echo $animation_att;}?>>
						<div class="fm-item-title"><?php echo esc_html($column4);?></div>
						<?php if($fm_column4_img){?><div class="fm-item-img"><img alt="<?php echo esc_attr($column4);?>" src="<?php echo esc_url($fm_column4_img);?>"/></div><?php }?>
						<?php if(!$fm_column4_img){?><?php if($fm_column4_sub){?><div class="fm-item-separator"></div><?php }?><?php }?>
						<?php if($fm_column4_sub){?><div class="fm-item-subtitle"><?php echo esc_html($fm_column4_sub);?></div><?php }?>
					</div></div>
				<?php }?>
			</div>
		</div>
