...
<div class="<?php if($cc){ ?>col-md-6<?php } else{?>col-md-12<?php } ?><?php if($footer_bottom_a_type){?> cre-animate<?php }?>"<?php if($footer_bottom_a_type){ echo $animation_att;}?>>
	<p class="copyright"><?php echo wp_kses($footer_copyright, array('a' => array('href' => array(),'title' => array()),'p' => array(),'span' => array('style' => array()),'b' => array(),'i' => array(),'u' => array(),'em' => array(),'strong' => array())); ?></p>
</div>
<?php } ?>