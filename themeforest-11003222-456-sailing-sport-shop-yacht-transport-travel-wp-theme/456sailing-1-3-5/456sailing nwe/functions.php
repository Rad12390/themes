...
define( 'GETTEXT_DOMAIN', '456sailing' );
...
function lpd_enqueue_scripts() {
    ...
    wp_register_script('menu3d1', THEME_ASSETS.'menu/menu3d1.js', false, false, true);
    
    wp_register_script('stellar', THEME_ASSETS.'js/jquery.stellar.min.js', false, false, true);
    
    // 3d navigation effect
    wp_register_script('custom_modernizr', THEME_ASSETS.'js/modernizr.custom.js', false, false, true);
    // 3d navigation effect END
...
require_once (TEMPLATEPATH. '/functions/page_header_bg.php');
...
if (is_plugin_active('essential-grid/essential-grid.php')) { include_once (TEMPLATEPATH. '/functions/metabox/functions/add_meta_box-essential-grid-header.php');}
