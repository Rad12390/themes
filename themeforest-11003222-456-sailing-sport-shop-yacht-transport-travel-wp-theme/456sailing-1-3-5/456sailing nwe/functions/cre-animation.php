...
jQuery(document).ready(function() {
	...
	.css('opacity', '0')
	.attr('data-animation','<?php echo esc_js($sidebar_a_type); ?>')
...
jQuery(document).ready(function() {
	...
	.addClass('cre-animate')
	.css('opacity', '0')
	.attr('data-animation','<?php echo esc_js($footer_a_type); ?>')
...
jQuery(document).ready(function() {
	...
	.addClass('cre-animate')
	.css('opacity', '0')
	.attr('data-animation','<?php echo esc_js($footer_top_a_type); ?>')
