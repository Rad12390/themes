...
function vc_mega_header2_func( $atts, $content = null ) {
   ...
   $content = wpb_js_remove_wpautop($content); // fix unclosed/unwanted paragraph tags in $content
	...
	if($title_color||$title_font_size||$title_font_weight||$title_letter_spacing){$title_styles = ' style="'.$title_color.''.$title_font_size.''.$title_font_weight.''.$title_letter_spacing.'"';}
	
	if($description_font_size||$description_color||$description_letter_spacing||$description_font_weight){$description_styles = ' style="'.$description_font_size.''.$description_color.''.$description_letter_spacing.''.$description_font_weight.'"';}
	
	if($content_font_size||$content_color||$content_letter_spacing||$content_line_height||$content_font_weight){$content_styles = ' style="'.$content_font_size.''.$content_color.''.$content_letter_spacing.''.$content_line_height.''.$content_font_weight.'"';}
   ...
   <div class="lpd-mega-header2<?php if($header_type=='type-2'){?> lpd-mega-heade-type-2<?php } ?>"<?php echo $styles; ?>>
	<?php if($header_type=='type-1'){?>
		<?php if($title){?><h3<?php echo $title_styles; ?><?php if($title_font_style){?> class="mh2-font-style"<?php } ?>><?php echo esc_html($title); ?></h3><?php } ?>
