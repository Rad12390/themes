   ...
   extract( shortcode_atts( array(
	...
	if ( empty( $order ) ) {
		...
		if ( $products->have_posts() ) : ?>
			...
			<div class="row">
			<ul class="lpd-products owl-carousel-<?php echo esc_attr($carousel_product_category_ID);?>">
	...
	$columns = $shortcode_atts['columns'];
		...
		/* <![CDATA[ */
            jQuery(document).ready(function() {
              jQuery('.owl-carousel-<?php echo esc_js($carousel_product_category_ID);?>').owlCarousel({
