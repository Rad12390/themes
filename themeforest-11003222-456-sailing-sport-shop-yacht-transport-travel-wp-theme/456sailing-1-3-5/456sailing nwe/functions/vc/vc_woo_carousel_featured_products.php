...
function vc_woo_carousel_featured_products_func( $atts, $content = null ) {
   extract( shortcode_atts( array(
	...
	if ( empty( $order ) ) {
		...
		if ( $products->have_posts() ) : ?>
			...
			<div class="row">
			<ul class="lpd-products owl-carousel-<?php echo esc_attr($carousel_featured_products_ID);?>">
	...
	$columns = $shortcode_atts['columns'];
		...
		/* <![CDATA[ */
            jQuery(document).ready(function() {
              jQuery('.owl-carousel-<?php echo esc_js($carousel_featured_products_ID);?>').owlCarousel({
