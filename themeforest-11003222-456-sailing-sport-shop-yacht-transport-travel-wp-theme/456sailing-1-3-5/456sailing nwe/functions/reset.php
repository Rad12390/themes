...
function lpd_register_menu() {
	register_nav_menu('primary-menu', esc_html__('Primary Menu', GETTEXT_DOMAIN));
	register_nav_menu('left-meta-menu', esc_html__('Left Header Meta Menu', GETTEXT_DOMAIN));
	register_nav_menu('right-meta-menu', esc_html__('Right Header Meta Menu', GETTEXT_DOMAIN));
	register_nav_menu('left-header-menu', esc_html__('Left Header Menu', GETTEXT_DOMAIN));
	register_nav_menu('right-header-menu', esc_html__('Right Header Menu', GETTEXT_DOMAIN));
	register_nav_menu('footer-menu', esc_html__('Footer Menu', GETTEXT_DOMAIN));
}
...
if ( function_exists( 'add_theme_support' ) ) {
	...
	add_image_size( 'theme-size-3x2', 850, 566, true ); // 2x3
	...
	add_image_size( 'theme-size-2x3', 566, 850, true ); // 3x2
}
