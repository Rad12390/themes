...
$portfolio_header_image_type=$tax_portfolio_category_header_image_type=$tax_portfolio_tags_header_image_type=$shop_category_header_image_type=$shop_tag_header_image_type=$product_header_image_type=$tax_post_tag_header_image_type=$tax_category_header_image_type=$post_header_image_type=$page_header_image_type=$page_header_image_bg=$blog_header_image_bg=$post_header_image_bg=$shop_search_header_image_bg=$shop_category_header_image_bg=$shop_tag_header_image_bg=$portfolio_header_image_bg=$post_header_image_bg=$tax_category_header_image_bg=$tax_post_tag_header_image_bg=$tax_portfolio_category_header_image_bg=$tax_portfolio_tags_header_image_bg=$archive_header_image_bg=$product_header_image_bg=$team_header_image_type=$team_header_image_bg=$essential_grid_header_image_bg=$essential_grid_header_image_type=$tax_team_category_header_image_bg=$tax_team_category_header_image_type=$tax_team_tags_header_image_bg=$tax_team_tags_header_image_type = "";
if(is_page()){
...
if(is_singular('essential_grid')){
	$essential_grid_header_image_bg = wp_get_attachment_image_src( get_post_meta($posts_page->ID, 'essential_grid_image', true), 'full' );
	$essential_grid_header_image_type =get_post_meta($posts_page->ID, 'essential_grid_type', true);
}
...
if ($page_header_image_bg||$blog_header_image_bg||$product_header_image_bg||$shop_search_header_image_bg||$shop_category_header_image_bg||$shop_tag_header_image_bg||$portfolio_header_image_bg||$post_header_image_bg||$tax_category_header_image_bg||$tax_post_tag_header_image_bg||$tax_portfolio_category_header_image_bg||$tax_portfolio_tags_header_image_bg||$archive_header_image_bg||$team_header_image_bg||$essential_grid_header_image_bg||$tax_team_category_header_image_bg||$tax_team_tags_header_image_bg) {
	...
	if(is_home()){
		...
		if ($blog_header_image_type=='parallax') {
			$class = 'class="page-header-image" data-stellar-background-ratio="0.7" ';
		}
		if ($blog_header_image_type=='repeat') {
			$class = 'class="page-header-image-repeat" ';
		}
		if ($blog_header_image_type=='full') {
			$class = 'class="page-header-image" ';
		}
	
	} else{
		
		if ($tax_portfolio_tags_header_image_type =='parallax'||$tax_portfolio_category_header_image_type =='parallax'||$portfolio_header_image_type =='parallax'||$shop_tag_header_image_type =='parallax'||$shop_category_header_image_type =='parallax'||$product_header_image_type=='parallax'||$tax_post_tag_header_image_type=='parallax'||$tax_category_header_image_type=='parallax'||$post_header_image_type=='parallax'||$page_header_image_type=='parallax'||$team_header_image_type=='parallax'||$tax_team_category_header_image_type=='parallax'||$tax_team_tags_header_image_type=='parallax'||$essential_grid_header_image_type=='parallax') {
			$class = 'class="page-header-image" data-stellar-background-ratio="0.7" ';
		}
		if ($tax_portfolio_tags_header_image_type =='repeat'||$tax_portfolio_category_header_image_type =='repeat'||$portfolio_header_image_type =='repeat'||$shop_tag_header_image_type =='repeat'||$shop_category_header_image_type =='repeat'||$product_header_image_type=='repeat'||$tax_post_tag_header_image_type=='repeat'||$tax_category_header_image_type=='repeat'||$post_header_image_type=='repeat'||$page_header_image_type=='repeat'||$team_header_image_type=='repeat'||$tax_team_category_header_image_type=='repeat'||$tax_team_tags_header_image_type=='repeat'||$essential_grid_header_image_type=='repeat') {
			$class = 'class="page-header-image-repeat" ';
		}
		if ($tax_portfolio_tags_header_image_type =='full'||$tax_portfolio_category_header_image_type =='full'||$portfolio_header_image_type =='full-width'||$shop_tag_header_image_type =='full'||$shop_category_header_image_type =='full'||$product_header_image_type=='full-width'||$tax_post_tag_header_image_type=='full'||$tax_category_header_image_type=='full'||$post_header_image_type=='full-width'||$page_header_image_type=='full-width'||$team_header_image_type=='full-width'||$tax_team_category_header_image_type=='full'||$tax_team_tags_header_image_type=='full'||$essential_grid_header_image_type=='full') {
			$class = 'class="page-header-image" ';
		}
	...
	if (is_plugin_active('woocommerce/woocommerce.php')) {
		...
		if(is_shop()){
			...
			if(is_search()){
				...
				#if($shop_search_header_image_bg){echo 'style="background-image: url('.$shop_search_header_image_bg[0].');"';}
			...
			if($shop_category_header_image_bg){
			
				echo $class;
				
				echo 'style="background-image: url('.esc_attr($shop_category_header_image_bg[0]).');"';
			
			}
		
		} elseif(is_tax("product_tag")){
			
			if($shop_tag_header_image_bg){
			
				echo $class;
				
				echo 'style="background-image: url('.esc_attr($shop_tag_header_image_bg[0]).');"';
		...
		if(!is_shop()&&!is_product_category()&&!is_tax("product_tag")){
			...
			if(is_singular('product')){ 
				if($product_header_image_bg){
				
					echo $class;
					
					echo 'style="background-image: url('.esc_attr($product_header_image_bg[0]).');"';
		...
		if(!is_home()){
			...
			if($page_header_image_bg){
				...
				echo 'style="background-image: url('.esc_attr($page_header_image_bg[0]).');"';
	...
	if(is_singular('portfolio')){
		...
		if($portfolio_header_image_bg){
		
			echo $class;
			
			echo 'style="background-image: url('.esc_attr($portfolio_header_image_bg[0]).');"';
	...
	if(is_singular('team')){
		...
		if($team_header_image_bg){
		
			echo $class;
			
			echo 'style="background-image: url('.esc_attr($team_header_image_bg[0]).');"';
	...
	if(is_singular('essential_grid')){
		...
		if($essential_grid_header_image_bg){
		
			echo $class;
			
			echo 'style="background-image: url('.esc_attr($essential_grid_header_image_bg[0]).');"';
	...
	if(is_singular()){
		...
		if($post_header_image_bg){
		
			echo $class;
			
			echo 'style="background-image: url('.esc_attr($post_header_image_bg[0]).');"';
	...
	if(is_category()){
		...
		if($tax_category_header_image_bg){
		
			echo $class;
			
			echo 'style="background-image: url('.esc_attr($tax_category_header_image_bg[0]).');"';
	...
	if(is_tag()){
		...
		if($tax_post_tag_header_image_bg){
		
			echo $class;
		
			echo 'style="background-image: url('.esc_attr($tax_post_tag_header_image_bg[0]).');"';
	...
	if(is_archive()){
		if(is_tax("portfolio_category")){
			...
			if($tax_portfolio_category_header_image_bg){
			
				echo $class;
				
				echo 'style="background-image: url('.esc_attr($tax_portfolio_category_header_image_bg[0]).');"';
			
			}
			
		} elseif(is_tax("portfolio_tags")){
		
			if($tax_portfolio_tags_header_image_bg){
			
				echo $class;
			
				echo 'style="background-image: url('.esc_attr($tax_portfolio_tags_header_image_bg[0]).');"';
				
			}
		
		} elseif(is_tax("team_category")){
		
			if($tax_team_category_header_image_bg){
			
				echo $class;
			
				echo 'style="background-image: url('.esc_attr($tax_team_category_header_image_bg[0]).');"';
			
			}
			
		} elseif(is_tax("team_tags")){
		
			if($tax_team_tags_header_image_bg){
			
				echo $class;
				
				echo 'style="background-image: url('.esc_attr($tax_team_tags_header_image_bg[0]).');"';
			
			}
		
		} else{
		
			#if($archive_header_image_bg){echo 'style="background-image: url('.$archive_header_image_bg[0].');"';}
	...
	if(is_home()){
		...
		if($blog_header_image_bg){
		
			echo $class;
		
			echo 'style="background-image: url('.esc_attr($blog_header_image_bg[0]).');"';
