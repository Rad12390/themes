  ...
  $custom_settings = array( 
	...
	-------------------------------------------------------------------*/
      ...
      array(
        ...
        'label'       => __('Button Letter Spacing', GETTEXT_DOMAIN),
        'desc'        => __('Letter spacing, only integers (ex: 0.1, 0.5, 1).', GETTEXT_DOMAIN),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'general_default',
        'rows'        => '',
       ...
       array(
        ...
        'label'       => __('Button Font Weight', GETTEXT_DOMAIN),
      ...
      array(
        ...
        'desc'        => __('"WPML Multilingual CMS" plugin must be activated.', GETTEXT_DOMAIN),
        'std'         => '',
        'type'        => 'select',
        'section'     => 'general_default',
        'rows'        => '',
	...
	-------------------------------------------------------------------*/
      ...
      array(
        'id'          => 'left_header_email_title',
        'label'       => __('Header Email Meta', GETTEXT_DOMAIN),
        'desc'        => '&#8595;',
        'std'         => '',
      ...
      array(
        'id'          => 'left_header_phone_title',
        'label'       => __('Header Phone Meta', GETTEXT_DOMAIN),
        'desc'        => '&#8595;',
        'std'         => '',
        'type'        => 'textblock-titled',
        'section'     => 'header_meta',
      ...
      array(
        'id'          => 'left_header_phone',
        'label'       => __('Phone', GETTEXT_DOMAIN),
        'desc'        => __('Enter a value for left header phone.', GETTEXT_DOMAIN),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'header_meta',
        'rows'        => '',
      ...
      array(
        'id'          => 'left_header_phone_url',
        'label'       => __('Phone URL', GETTEXT_DOMAIN),
        'desc'        => __("Input the full URL you'd like the button to link.", GETTEXT_DOMAIN),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'header_meta',
      ...
      array(
        'id'          => 'left_header_location_title',
        'label'       => __('Header Location Meta', GETTEXT_DOMAIN),
        'desc'        => '&#8595;',
        'std'         => '',
        'type'        => 'textblock-titled',
        'section'     => 'header_meta',
      ...
      array(
        'id'          => 'left_header_location',
        'label'       => __('Location', GETTEXT_DOMAIN),
        'desc'        => __('Enter a value for left header locations.', GETTEXT_DOMAIN),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'header_meta',
        'rows'        => '',
      ...
      array(
        'id'          => 'left_header_location_url',
        'label'       => __('Location URL', GETTEXT_DOMAIN),
        'desc'        => __("Input the full URL you'd like the button to link.", GETTEXT_DOMAIN),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'header_meta',
      ...
      array(
        'id'          => 'meta_contacts_location',
        'label'       => __('Meta Contacts Location', GETTEXT_DOMAIN),
        'desc'        => __('Select one of meta contacts location. The option is unavailable if you are using "Left Header Meta" or "Right Header Meta".', GETTEXT_DOMAIN),
        'std'         => '',
        'type'        => 'select',
        'section'     => 'header_meta',
        'rows'        => '',
	...
	array(
        'id'          => 'header_color',
        'label'       => __('Header Color', GETTEXT_DOMAIN),
        'desc'        => __('Pick the primary background color for header.', GETTEXT_DOMAIN),
        'std'         => '#1a74b1',
        'type'        => 'colorpicker',
	...
	array(
        'id'          => 'header_color_2',
        'label'       => __('Header Color 2', GETTEXT_DOMAIN),
        'desc'        => __('Pick the secondary background color for header.', GETTEXT_DOMAIN),
        'std'         => '#feb005',
        'type'        => 'colorpicker',
        'section'     => 'header_content',
        'rows'        => '',
      ...
      array(
        ...
        'choices'     => array( 
          array(
            'value'       => 'left',
            'label'       => __('Left (type1)', GETTEXT_DOMAIN),
            'src'         => ''
          ),
          array(
            'value'       => 'left_2',
            'label'       => __('Left (type2)', GETTEXT_DOMAIN),
            'src'         => ''
          ),
          array(
            'value'       => 'center',
      ...
      array(
        'id'          => 'left_header_m_tm',
        'label'       => __('Left Header Menu Top Margin', GETTEXT_DOMAIN),
        'desc'        => __('Margin top, only integers (ex: 1, 5, 10).', GETTEXT_DOMAIN),
        'std'         => '0',
        'type'        => 'text',
        'section'     => 'header_content',
      ...
      array(
        'id'          => 'right_header_m_tm',
        'label'       => __('Right Header Menu Top Margin', GETTEXT_DOMAIN),
        'desc'        => __('Margin top, only integers (ex: 1, 5, 10).', GETTEXT_DOMAIN),
        'std'         => '0',
        'type'        => 'text',
        'section'     => 'header_content',
      ...
      array(
        'id'          => 'search_locations',
        'label'       => __('Search Form Locations', GETTEXT_DOMAIN),
        ...
        'choices'     => array(
          ...
          array(
            ...
            'label'       => __('Bottom Right Header', GETTEXT_DOMAIN),
            'src'         => ''
          ),
        ),
      ),
      array(
        'id'          => 'search_tm',
        'label'       => __('Search Form Top Margin', GETTEXT_DOMAIN),
        'desc'        => __('Margin top, only integers (ex: 1, 5, 10), the option is not available for "Bottom Right Header" message box location.', GETTEXT_DOMAIN),
        'std'         => '0',
        'type'        => 'text',
        'section'     => 'header_content',
        'rows'        => '',
      ...
      array(
        'id'          => 'decorative_header_element',
        'label'       => __('Decorative Header Element', GETTEXT_DOMAIN),
        'desc'        => '&#8595;',
        'std'         => '',
        'type'        => 'textblock-titled',
        'section'     => 'header_content',
      ...
      array(
        'id'          => 'decorative_icon_header',
        'label'       => 'Decorative Icon',
        'desc'        => __('Upload decorative icon for header.', GETTEXT_DOMAIN),
        'std'         => '',
        'type'        => 'upload',
        'section'     => 'header_content',
        'rows'        => '',
      ...
      array(
        'id'          => 'decorative_icon_size',
        'label'       => __('Decorative Icon Size', GETTEXT_DOMAIN),
        'desc'        => __('Select one of decorative icon size.', GETTEXT_DOMAIN),
        'std'         => '30',
        'type'        => 'select',
        'section'     => 'header_content',
        'rows'        => '',
      ...
      array(
        ...
        'choices'     => array(
          ...
          array(
            'value'       => 'bottom_right',
            'label'       => __('Bottom Right', GETTEXT_DOMAIN),
            'src'         => ''
          )
        ),
      ),
      ...
      array(
        ...
        'desc'        => __('Margin top, only integers (ex: 1, 5, 10), the option is available only for "Left" & "Right" message box location.', GETTEXT_DOMAIN),
        'std'         => '0',
        'type'        => 'text',
        'section'     => 'header_content',
        'rows'        => '',
       ...
       array(
        'id'          => 'header_bottom',
        'label'       => __('Header Bottom', GETTEXT_DOMAIN),
        'desc'        => '&#8595;',
        'std'         => '',
        'type'        => 'textblock-titled',
        'section'     => 'header_content',
      ...
      array(
        'id'          => 'hb_left_container',
        'label'       => __('Left Container', GETTEXT_DOMAIN),
        'desc'        => __("The content for left header bottom container.", GETTEXT_DOMAIN),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'header_content',
        'rows'        => '',
      ...
      array(
        'id'          => 'hb_left_container_icon',
        'label'       => 'Left Container Icon',
        'desc'        => __('Upload left container icon, minimal size 30x30px.', GETTEXT_DOMAIN),
        'std'         => '',
        'type'        => 'upload',
        'section'     => 'header_content',
        'rows'        => '',
      ...
      array(
        'id'          => 'hb_left_container_icon_bg',
        'label'       => __('Left Container Icon Background Color', GETTEXT_DOMAIN),
        'desc'        => __('Pick the color for icon background.', GETTEXT_DOMAIN),
        'std'         => '#555',
        'type'        => 'colorpicker',
        'section'     => 'header_content',
      ...
      array(
        'id'          => 'hb_right_container',
        'label'       => __('Right Container', GETTEXT_DOMAIN),
        'desc'        => __("The content for right header bottom container.", GETTEXT_DOMAIN),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'header_content',
        'rows'        => '',
      ...
      array(
        'id'          => 'hb_right_container_icon',
        'label'       => 'Right Container Icon',
        'desc'        => __('Upload right container icon, minimal size 30x30px.', GETTEXT_DOMAIN),
        'std'         => '',
        'type'        => 'upload',
        'section'     => 'header_content',
        'rows'        => '',
      ...
      array(
        'id'          => 'hb_right_container_icon_bg',
        'label'       => __('Right Container Icon Background Color', GETTEXT_DOMAIN),
        'desc'        => __('Pick the color for icon background.', GETTEXT_DOMAIN),
        'std'         => '#555',
        'type'        => 'colorpicker',
        'section'     => 'header_content',
	...
	-------------------------------------------------------------------*/
      ...
      array(
        'id'          => 'h_sm_tm',
        'label'       => __('Social Media Top Margin', GETTEXT_DOMAIN),
        'desc'        => __('Margin top, only integers (ex: 1, 5, 10), the option is available only for "Left Header" & "Right Header" message box location.', GETTEXT_DOMAIN),
        'std'         => '0',
        'type'        => 'text',
        'section'     => 'header_sm',
        'rows'        => '',
	...
	-------------------------------------------------------------------*/
      ...
      array(
        'id'          => 'disable_sticky_cart',
        'label'       => __('Sticky Menu Shopping Cart', GETTEXT_DOMAIN),
        'desc'        => __('Check, if you want to disable sticky menu shopping cart (dropdown).', GETTEXT_DOMAIN),
        'std'         => '',
        'type'        => 'checkbox',
        'section'     => 'navigation',
        'rows'        => '',
      ...
      array(
        'id'          => 'disable_sticky_wpml',
        'label'       => __('Sticky Menu "WPML"', GETTEXT_DOMAIN),
        'desc'        => __('Check, if you want to disable sticky menu "WPML" language navigation.', GETTEXT_DOMAIN),
        'std'         => '',
        'type'        => 'checkbox',
        'section'     => 'navigation',
        'rows'        => '',
      ...
      array(
        'id'          => 'navigation_text_transform',
        'label'       => __('Navigation Text Transformation', GETTEXT_DOMAIN),
        'desc'        => __('Check, if you want to enable uppercase text transformation.', GETTEXT_DOMAIN),
        'std'         => '',
        'type'        => 'checkbox',
        'section'     => 'navigation',
        'rows'        => '',
      ...
      array(
        'id'          => 'navigation_letter_spacing',
        'label'       => __('Navigation Letter Spacing', GETTEXT_DOMAIN),
        'desc'        => __('Letter spacing, only integers (ex: 0.1, 0.5, 1).', GETTEXT_DOMAIN),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'navigation',
      ...
      array(
        'id'          => 'dropdown_text_transform',
        'label'       => __('Navigation Dropdown Text Transformation', GETTEXT_DOMAIN),
        'desc'        => __('Check, if you want to enable uppercase text transformation.', GETTEXT_DOMAIN),
        'std'         => '',
        'type'        => 'checkbox',
        'section'     => 'navigation',
      ...
      array(
        'id'          => 'dropdown_letter_spacing',
        'label'       => __('Navigation Dropdown Letter Spacing', GETTEXT_DOMAIN),
        'desc'        => __('Letter spacing, only integers (ex: 0.1, 0.5, 1).', GETTEXT_DOMAIN),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'navigation',
       ...
       array(
        'id'          => 'nav_style',
        'label'       => __('Navigation Styles', GETTEXT_DOMAIN),
        'desc'        => __('Set navigation style.', GETTEXT_DOMAIN),
        'std'         => '',
        'type'        => 'select',
        'section'     => 'navigation',
        'rows'        => '',
        ...
        'choices'     => array( 
          array(
            'value'       => 'standard',
            'label'       => __('Standard', GETTEXT_DOMAIN),
            'src'         => ''
          ),
          array(
            'value'       => 'simple',
            'label'       => __('Simple', GETTEXT_DOMAIN),
            'src'         => ''
          )
        ),
      ),
       array(
        'id'          => 'nav_type',
        'label'       => __('Navigation Type', GETTEXT_DOMAIN),
        'desc'        => __('Set navigation type.', GETTEXT_DOMAIN),
        'std'         => '3deffect',
        'type'        => 'select',
        'section'     => 'navigation',
        'rows'        => '',
        ...
        'choices'     => array( 
          ...
          array(
            'value'       => '3deffect',
            'label'       => __('3d Effect', GETTEXT_DOMAIN),
            'src'         => ''
          )
        ),
      ),
...
%page_title% - Will display current page title.', GETTEXT_DOMAIN),
	...
	-------------------------------------------------------------------*/
      ...
      array(
        'id'          => 'page_title_bg',
        'label'       => __('Page Title Background Color', GETTEXT_DOMAIN),
        'desc'        => __('Pick the color for page title background.', GETTEXT_DOMAIN),
        'std'         => '#e1e1e1',
        'type'        => 'colorpicker',
        'section'     => 'theme_options',
        'rows'        => '',
	...
	-------------------------------------------------------------------*/
      ...
      array(
        'id'          => 'product_styles',
        'label'       => __('Product Styles', GETTEXT_DOMAIN),
        'desc'        => '&#8595;',
        'std'         => '',
        'type'        => 'textblock-titled',
        'section'     => 'shop_options',
       ...
       array(
        'id'          => 'prodcut_font_weight',
        'label'       => __('Title Font Weight', GETTEXT_DOMAIN),
        'desc'        => __('Set product title font weight.', GETTEXT_DOMAIN),
        'std'         => '400',
        'type'        => 'select',
        'section'     => 'shop_options',
        'rows'        => '',
      ...
      array(
        ...
        'label'       => __('Title Font Size', GETTEXT_DOMAIN),
        'desc'        => __('Product title font size, only integers (ex: 16, 18, 24).', GETTEXT_DOMAIN),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'shop_options',
        'rows'        => '',
      ...
      array(
        ...
        'label'       => __('Title Line Hight', GETTEXT_DOMAIN),
        'desc'        => __('Product title line height, only integers (ex: 16, 18, 24).', GETTEXT_DOMAIN),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'shop_options',
        'rows'        => '',
      ...
      array(
        'id'          => 'product_letter_spacing',
        'label'       => __('Title Letter Spacing', GETTEXT_DOMAIN),
        'desc'        => __('Product title letter spacing, only integers (ex: 0.5, 0.75, 1).', GETTEXT_DOMAIN),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'shop_options',
        'rows'        => '',
      ...
      array(
        'id'          => 'product_uppercase',
        'label'       => __('Title Uppercase', GETTEXT_DOMAIN),
        'desc'        => __('Check for enabling uppercase text transformation.', GETTEXT_DOMAIN),
        'std'         => '',
        'type'        => 'checkbox',
        'section'     => 'shop_options',
        'rows'        => '',
      ...
      array(
        'id'          => 'product_secondary_font_family',
        'label'       => __('Secondary Font Family', GETTEXT_DOMAIN),
        'desc'        => __('Check for enabling secondary font family for title.', GETTEXT_DOMAIN),
        'std'         => '',
        'type'        => 'checkbox',
        'section'     => 'shop_options',
        'rows'        => '',
      ...
      array(
        'id'          => 'sku_font_size',
        'label'       => __('SKU Font Size', GETTEXT_DOMAIN),
        'desc'        => __('SKU font size, only integers (ex: 16, 18, 24).', GETTEXT_DOMAIN),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'shop_options',
        'rows'        => '',
      ...
      array(
        ...
        'label'       => __('Product Price Font Size', GETTEXT_DOMAIN),
        'desc'        => __('Product price font size, only integers (ex: 16, 18, 24).', GETTEXT_DOMAIN),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'shop_options',
        'rows'        => '',
...
.product-categories{
	...
	array(
        ...
        'desc'        => __('Pick the primary background color for meta footer.', GETTEXT_DOMAIN),
        'std'         => '#1a74b1',
        'type'        => 'colorpicker',
        'section'     => 'footer_meta',
        'rows'        => '',
	...
	array(
        'id'          => 'footer_meta_color_2',
        'label'       => __('Footer Meta Color 2', GETTEXT_DOMAIN),
        'desc'        => __('Pick the secondary background color for meta footer.', GETTEXT_DOMAIN),
        'std'         => '#feb005',
        'type'        => 'colorpicker',
        'section'     => 'footer_meta',
        'rows'        => '',
      ...
      array(
        'id'          => 'fm_column1_sub',
        'label'       => __('Sub-title (column 1)', GETTEXT_DOMAIN),
      ...
      array(
        'id'          => 'fm_column1_img',
        'label'       => __('Image (column 1)', GETTEXT_DOMAIN),
        'desc'        => __('Upload an image for column 1.', GETTEXT_DOMAIN),
        'std'         => '',
        'type'        => 'upload',
        'section'     => 'footer_meta',
        'rows'        => '',
      ...
      array(
        'id'          => 'fm_column1_padding',
        'label'       => __('Top Padding (column 1)', GETTEXT_DOMAIN),
        'desc'        => __('Padding top, only integers (ex: 1, 5, 10).', GETTEXT_DOMAIN),
        'std'         => '30',
        'type'        => 'text',
        'section'     => 'footer_meta',
      ...
      array(
        'id'          => 'fm_column2_sub',
        'label'       => __('Sub-title (column 2)', GETTEXT_DOMAIN),
        'desc'        => __('Enter a value for for sub-title.', GETTEXT_DOMAIN),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'footer_meta',
        'rows'        => '',
      ...
      array(
        'id'          => 'fm_column2_img',
        'label'       => __('Image (column 2)', GETTEXT_DOMAIN),
        'desc'        => __('Upload an image for column 2.', GETTEXT_DOMAIN),
        'std'         => '',
        'type'        => 'upload',
        'section'     => 'footer_meta',
        'rows'        => '',
      ...
      array(
        'id'          => 'fm_column2_padding',
        'label'       => __('Top Padding (column 2)', GETTEXT_DOMAIN),
        'desc'        => __('Padding top, only integers (ex: 1, 5, 10).', GETTEXT_DOMAIN),
        'std'         => '30',
        'type'        => 'text',
        'section'     => 'footer_meta',
      ...
      array(
        'id'          => 'fm_column3_sub',
        'label'       => __('Sub-title (column 3)', GETTEXT_DOMAIN),
        'desc'        => __('Enter a value for sub-title.', GETTEXT_DOMAIN),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'footer_meta',
      ...
      array(
        'id'          => 'fm_column3_img',
        'label'       => __('Image (column 3)', GETTEXT_DOMAIN),
        'desc'        => __('Upload an image for column 3.', GETTEXT_DOMAIN),
        'std'         => '',
        'type'        => 'upload',
        'section'     => 'footer_meta',
        'rows'        => '',
      ...
      array(
        'id'          => 'fm_column3_padding',
        'label'       => __('Top Padding (column 3)', GETTEXT_DOMAIN),
        'desc'        => __('Padding top, only integers (ex: 1, 5, 10).', GETTEXT_DOMAIN),
        'std'         => '30',
        'type'        => 'text',
        'section'     => 'footer_meta',
      ...
      array(
        'id'          => 'fm_column4_sub',
        'label'       => __('Sub-title (column 4)', GETTEXT_DOMAIN),
        'desc'        => __('Enter a value for sub-title.', GETTEXT_DOMAIN),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'footer_meta',
      ...
      array(
        'id'          => 'fm_column4_img',
        'label'       => __('Image (column 4)', GETTEXT_DOMAIN),
        'desc'        => __('Upload an image for column 4.', GETTEXT_DOMAIN),
        'std'         => '',
        'type'        => 'upload',
        'section'     => 'footer_meta',
        'rows'        => '',
      ...
      array(
        'id'          => 'fm_column4_padding',
        'label'       => __('Top Padding (column 4)', GETTEXT_DOMAIN),
        'desc'        => __('Padding top, only integers (ex: 1, 5, 10).', GETTEXT_DOMAIN),
        'std'         => '30',
        'type'        => 'text',
        'section'     => 'footer_meta',
      ...
      array(
        'id'          => 'sm_sub',
        'label'       => __('Sub-title (social media)', GETTEXT_DOMAIN),
        'desc'        => __('Enter a value for social media sub-title.', GETTEXT_DOMAIN),
        'std'         => '',
        'type'        => 'text',
        'section'     => 'footer_meta',
        'rows'        => '',
      ...
      array(
        'id'          => 'sm_padding',
        'label'       => __('Top Padding (social media)', GETTEXT_DOMAIN),
        'desc'        => __('Padding top, only integers (ex: 1, 5, 10).', GETTEXT_DOMAIN),
        'std'         => '30',
        'type'        => 'text',
        'section'     => 'footer_meta',
...
array(
      ...
      array(
        ...
        'choices'     => array( 
          array(
            'value'       => 'enable',
            'label'       => __('Lignt Background', GETTEXT_DOMAIN),
            'src'         => ''
          )
        ),
      ),
